...
func invoke(ctx context.Context, cc grpc.ClientConnInterface, method string, in, out any, opts ...grpc.CallOption) error {
    cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
    return cc.Invoke(ctx, method, in, out, cOpts...)
}

func (c *routerServiceClient) TestConnect(ctx context.Context, in *TestConnectRequest, opts ...grpc.CallOption) (*TestConnectResponse,error){out:=new(TestConnectResponse);if err:=invoke(ctx,c.cc,RouterService_TestConnect_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) GetDashboard(ctx context.Context, in *GetDashboardRequest, opts ...grpc.CallOption) (*GetDashboardResponse,error){out:=new(GetDashboardResponse);if err:=invoke(ctx,c.cc,RouterService_GetDashboard_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListActiveHotspotUsers(ctx context.Context, in *ListActiveRequest, opts ...grpc.CallOption) (*ListActiveResponse,error){out:=new(ListActiveResponse);if err:=invoke(ctx,c.cc,RouterService_ListActiveHotspotUsers_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListHotspotUsers(ctx context.Context, in *ListHotspotUsersRequest, opts ...grpc.CallOption) (*ListHotspotUsersResponse,error){out:=new(ListHotspotUsersResponse);if err:=invoke(ctx,c.cc,RouterService_ListHotspotUsers_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) AddHotspotUser(ctx context.Context, in *AddHotspotUserRequest, opts ...grpc.CallOption) (*AddHotspotUserResponse,error){out:=new(AddHotspotUserResponse);if err:=invoke(ctx,c.cc,RouterService_AddHotspotUser_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) RemoveHotspotUser(ctx context.Context, in *RemoveHotspotUserRequest, opts ...grpc.CallOption) (*RemoveHotspotUserResponse,error){out:=new(RemoveHotspotUserResponse);if err:=invoke(ctx,c.cc,RouterService_RemoveHotspotUser_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) DisableHotspotUser(ctx context.Context, in *DisableHotspotUserRequest, opts ...grpc.CallOption) (*DisableHotspotUserResponse,error){out:=new(DisableHotspotUserResponse);if err:=invoke(ctx,c.cc,RouterService_DisableHotspotUser_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) EnableHotspotUser(ctx context.Context, in *EnableHotspotUserRequest, opts ...grpc.CallOption) (*EnableHotspotUserResponse,error){out:=new(EnableHotspotUserResponse);if err:=invoke(ctx,c.cc,RouterService_EnableHotspotUser_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListHotspotProfiles(ctx context.Context, in *ListProfilesRequest, opts ...grpc.CallOption) (*ListProfilesResponse,error){out:=new(ListProfilesResponse);if err:=invoke(ctx,c.cc,RouterService_ListHotspotProfiles_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) GetHotspotProfile(ctx context.Context, in *GetProfileRequest, opts ...grpc.CallOption) (*GetProfileResponse,error){out:=new(GetProfileResponse);if err:=invoke(ctx,c.cc,RouterService_GetHotspotProfile_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) AddHotspotProfile(ctx context.Context, in *AddHotspotProfileRequest, opts ...grpc.CallOption) (*AddHotspotProfileResponse,error){out:=new(AddHotspotProfileResponse);if err:=invoke(ctx,c.cc,RouterService_AddHotspotProfile_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) UpdateHotspotProfile(ctx context.Context, in *UpdateHotspotProfileRequest, opts ...grpc.CallOption) (*UpdateHotspotProfileResponse,error){out:=new(UpdateHotspotProfileResponse);if err:=invoke(ctx,c.cc,RouterService_UpdateHotspotProfile_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) DeleteHotspotProfile(ctx context.Context, in *DeleteHotspotProfileRequest, opts ...grpc.CallOption) (*DeleteHotspotProfileResponse,error){out:=new(DeleteHotspotProfileResponse);if err:=invoke(ctx,c.cc,RouterService_DeleteHotspotProfile_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) BulkRemoveHotspotUsers(ctx context.Context, in *BulkRemoveHotspotUsersRequest, opts ...grpc.CallOption) (*BulkRemoveHotspotUsersResponse,error){out:=new(BulkRemoveHotspotUsersResponse);if err:=invoke(ctx,c.cc,RouterService_BulkRemoveHotspotUsers_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) SetupExpiryScheduler(ctx context.Context, in *SetupExpirySchedulerRequest, opts ...grpc.CallOption) (*SetupExpirySchedulerResponse,error){out:=new(SetupExpirySchedulerResponse);if err:=invoke(ctx,c.cc,RouterService_SetupExpiryScheduler_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListDhcpLeases(ctx context.Context, in *ListDhcpLeasesRequest, opts ...grpc.CallOption) (*ListDhcpLeasesResponse,error){out:=new(ListDhcpLeasesResponse);if err:=invoke(ctx,c.cc,RouterService_ListDhcpLeases_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListSchedulers(ctx context.Context, in *ListSchedulersRequest, opts ...grpc.CallOption) (*ListSchedulersResponse,error){out:=new(ListSchedulersResponse);if err:=invoke(ctx,c.cc,RouterService_ListSchedulers_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) AddScheduler(ctx context.Context, in *AddSchedulerRequest, opts ...grpc.CallOption) (*AddSchedulerResponse,error){out:=new(AddSchedulerResponse);if err:=invoke(ctx,c.cc,RouterService_AddScheduler_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) UpdateScheduler(ctx context.Context, in *UpdateSchedulerRequest, opts ...grpc.CallOption) (*UpdateSchedulerResponse,error){out:=new(UpdateSchedulerResponse);if err:=invoke(ctx,c.cc,RouterService_UpdateScheduler_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListLogs(ctx context.Context, in *ListLogsRequest, opts ...grpc.CallOption) (*ListLogsResponse,error){out:=new(ListLogsResponse);if err:=invoke(ctx,c.cc,RouterService_ListLogs_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListSellingScripts(ctx context.Context, in *ListSellingScriptsRequest, opts ...grpc.CallOption) (*ListSellingScriptsResponse,error){out:=new(ListSellingScriptsResponse);if err:=invoke(ctx,c.cc,RouterService_ListSellingScripts_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) DeleteSellingScripts(ctx context.Context, in *DeleteSellingScriptsRequest, opts ...grpc.CallOption) (*DeleteSellingScriptsResponse,error){out:=new(DeleteSellingScriptsResponse);if err:=invoke(ctx,c.cc,RouterService_DeleteSellingScripts_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) GetSystemResource(ctx context.Context, in *SystemResourceRequest, opts ...grpc.CallOption) (*SystemResourceResponse,error){out:=new(SystemResourceResponse);if err:=invoke(ctx,c.cc,RouterService_GetSystemResource_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) GetInterfaces(ctx context.Context, in *InterfacesRequest, opts ...grpc.CallOption) (*InterfacesResponse,error){out:=new(InterfacesResponse);if err:=invoke(ctx,c.cc,RouterService_GetInterfaces_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListSessions(ctx context.Context, in *ListSessionsRequest, opts ...grpc.CallOption) (*ListSessionsResponse,error){out:=new(ListSessionsResponse);if err:=invoke(ctx,c.cc,RouterService_ListSessions_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) GetSession(ctx context.Context, in *GetSessionRequest, opts ...grpc.CallOption) (*GetSessionResponse,error){out:=new(GetSessionResponse);if err:=invoke(ctx,c.cc,RouterService_GetSession_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) CreateSession(ctx context.Context, in *CreateSessionRequest, opts ...grpc.CallOption) (*CreateSessionResponse,error){out:=new(CreateSessionResponse);if err:=invoke(ctx,c.cc,RouterService_CreateSession_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) UpdateSession(ctx context.Context, in *UpdateSessionRequest, opts ...grpc.CallOption) (*UpdateSessionResponse,error){out:=new(UpdateSessionResponse);if err:=invoke(ctx,c.cc,RouterService_UpdateSession_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) DeleteSession(ctx context.Context, in *DeleteSessionRequest, opts ...grpc.CallOption) (*DeleteSessionResponse,error){out:=new(DeleteSessionResponse);if err:=invoke(ctx,c.cc,RouterService_DeleteSession_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListPppSecrets(ctx context.Context, in *ListPppSecretsRequest, opts ...grpc.CallOption) (*ListPppSecretsResponse,error){out:=new(ListPppSecretsResponse);if err:=invoke(ctx,c.cc,RouterService_ListPppSecrets_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) GetPppSecret(ctx context.Context, in *GetPppSecretRequest, opts ...grpc.CallOption) (*GetPppSecretResponse,error){out:=new(GetPppSecretResponse);if err:=invoke(ctx,c.cc,RouterService_GetPppSecret_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) AddPppSecret(ctx context.Context, in *AddPppSecretRequest, opts ...grpc.CallOption) (*AddPppSecretResponse,error){out:=new(AddPppSecretResponse);if err:=invoke(ctx,c.cc,RouterService_AddPppSecret_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) UpdatePppSecret(ctx context.Context, in *UpdatePppSecretRequest, opts ...grpc.CallOption) (*UpdatePppSecretResponse,error){out:=new(UpdatePppSecretResponse);if err:=invoke(ctx,c.cc,RouterService_UpdatePppSecret_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) DeletePppSecret(ctx context.Context, in *DeletePppSecretRequest, opts ...grpc.CallOption) (*DeletePppSecretResponse,error){out:=new(DeletePppSecretResponse);if err:=invoke(ctx,c.cc,RouterService_DeletePppSecret_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) EnablePppSecret(ctx context.Context, in *EnablePppSecretRequest, opts ...grpc.CallOption) (*EnablePppSecretResponse,error){out:=new(EnablePppSecretResponse);if err:=invoke(ctx,c.cc,RouterService_EnablePppSecret_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) DisablePppSecret(ctx context.Context, in *DisablePppSecretRequest, opts ...grpc.CallOption) (*DisablePppSecretResponse,error){out:=new(DisablePppSecretResponse);if err:=invoke(ctx,c.cc,RouterService_DisablePppSecret_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListPppProfiles(ctx context.Context, in *ListPppProfilesRequest, opts ...grpc.CallOption) (*ListPppProfilesResponse,error){out:=new(ListPppProfilesResponse);if err:=invoke(ctx,c.cc,RouterService_ListPppProfiles_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) AddPppProfile(ctx context.Context, in *AddPppProfileRequest, opts ...grpc.CallOption) (*AddPppProfileResponse,error){out:=new(AddPppProfileResponse);if err:=invoke(ctx,c.cc,RouterService_AddPppProfile_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) UpdatePppProfile(ctx context.Context, in *UpdatePppProfileRequest, opts ...grpc.CallOption) (*UpdatePppProfileResponse,error){out:=new(UpdatePppProfileResponse);if err:=invoke(ctx,c.cc,RouterService_UpdatePppProfile_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) DeletePppProfile(ctx context.Context, in *DeletePppProfileRequest, opts ...grpc.CallOption) (*DeletePppProfileResponse,error){out:=new(DeletePppProfileResponse);if err:=invoke(ctx,c.cc,RouterService_DeletePppProfile_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListPppActive(ctx context.Context, in *ListPppActiveRequest, opts ...grpc.CallOption) (*ListPppActiveResponse,error){out:=new(ListPppActiveResponse);if err:=invoke(ctx,c.cc,RouterService_ListPppActive_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) DisconnectPppActive(ctx context.Context, in *DisconnectPppActiveRequest, opts ...grpc.CallOption) (*DisconnectPppActiveResponse,error){out:=new(DisconnectPppActiveResponse);if err:=invoke(ctx,c.cc,RouterService_DisconnectPppActive_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
func (c *routerServiceClient) ListPppPools(ctx context.Context, in *ListPppPoolsRequest, opts ...grpc.CallOption) (*ListPppPoolsResponse,error){out:=new(ListPppPoolsResponse);if err:=invoke(ctx,c.cc,RouterService_ListPppPools_FullMethodName,in,out,opts...);err!=nil{return nil,err};return out,nil}
