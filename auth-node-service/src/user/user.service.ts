...
import { UserEntity, UserRole, UserPermissions } from '../entities/user.entity';
...
// Default permissions per role (mirrors the monolith).
...
export class UserService {
  ...
  private toSafe(u: UserEntity): Omit<AppUser, 'password'> {
