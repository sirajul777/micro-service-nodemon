    ...
    <div className="stack">
      <div className="hero">
        <div>
          ...
          <p>
            Track generated batches and synchronize voucher usage with RouterOS.
          </p>
        </div>
      ...
      <section className="panel">
        <div className="panel-head">
          <div>
            <h3>
              <FileText size={15} /> Batches
            </h3>
            <span>
              {visible.length} of {rows.length} batches
            </span>
          </div>
        ...
        <div className="table-controls">
          <div className="table-search">
            ...
            <input
              ...
              placeholder="Search batch, profile, status..."
            />
          </div>
        </div>
        <div className="table-wrap">
          ...
          {!visible.length && (
            <div className="empty">No voucher batches found.</div>
          )}
        </div>
      </section>
    </div>
