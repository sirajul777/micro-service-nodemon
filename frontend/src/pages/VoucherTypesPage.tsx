    ...
    <div className="stack">
      ...
      <section className="panel">
        <div className="panel-head">
          <div>
            <h3>
              <BarChart3 size={15} /> Types
            </h3>
            <span>
              {visible.length} of {rows.length} voucher types
            </span>
          </div>
        ...
        <div className="table-controls">
          <div className="table-search">
            ...
            <input
              ...
              placeholder="Search name, profile, duration..."
            />
          </div>
        </div>
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              {visible.map((r, i) => {
                ...
                const enabled = !(
                  r.enabled === false ||
                  String(r.enabled).toLowerCase() === "false"
                );
                return (
                  <tr key={id}>
                    <td>
          ...
          {!visible.length && (
            <div className="empty">No voucher types found.</div>
          )}
        </div>
      </section>
    ...
    <div className="modal-backdrop">
      <div className="modal">
        <div className="modal-head">
          <div>
            <span className="eyebrow">VOUCHER TYPE</span>
          ...
          <div className="form-grid">
            ...
            <label>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((f: any) => ({ ...f, enabled: e.target.checked }))
                }
              />
            </label>
          </div>
