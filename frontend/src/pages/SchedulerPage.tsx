    ...
    <div className="stack scheduler-page">
      ...
      <section className="panel">
        <div className="panel-head">
          <div>
            <h3>
              <CalendarClock size={15} /> Scheduled Jobs
            </h3>
            <span>
              {visible.length} of {rows.length} schedulers
            </span>
          </div>
          <span className="badge">{busy ? "WORKING" : "LIVE"}</span>
        </div>
        <div className="table-controls">
          <div className="table-search scheduler-search">
            <Search size={15} />
            <input
              value={query}
              onChange={(e) => setQuery(e.target.value)}
              placeholder="Search name, event, comment..."
            />
          </div>
        </div>
        <div className="table-wrap">
                ...
                return (
                  <tr key={name}>
                    ...
                    <td className="code-cell">
                      {r.onEvent || r.on_event || "—"}
                    </td>
                    <td>
                      <span
                        className={`schedule-status${disabled ? " is-disabled" : ""}`}
                      >
                        <i />
          ...
          {!visible.length && (
            <div className="empty">No scheduler entries found.</div>
          )}
        </div>
      </section>
      ...
      <div className="modal scheduler-modal">
        <div className="modal-head">
          <div>
            ...
            <h3>{editing ? "Edit Scheduler" : "Add Scheduler"}</h3>
          </div>
        ...
        >
          <div className="form-grid">
            ...
            {field(
              ...
              "/system script run ...",
              false,
              "RouterOS command or script to execute.",
            )}
            ...
            <label>
              ...
              <div className="checkbox-field">
                ...
                />
                <span>Disable scheduled execution</span>
              </div>
            </label>
          </div>
